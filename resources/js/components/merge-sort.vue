            ...
            <div class="row">
                ...
                >
                    <div>
                        ...
                        />
                        <span class="ml-4"
                            >Speed: {{ setSpeed }} ms/iteration</span
                        >
                    </div>
    ...
    methods: {
        sort: function() {
            ...
            const merge = (leftArr, rightArr) => {
                ...
                console.log(orderedPortion);

                // Here I set the asynchronous iterations
                orderedPortion.forEach(el => {
                    setTimeout(
                        function() {
                            ...
                            if (
                                iterationTurn === this.iterationIndexes.length
                            ) {
        ...
        initArrayIndexes: function(length) {
            ...
            const slicer = array => {
                ...
                return joiner(slicer(leftArr), slicer(rightArr));
            };

            slicer(indexes);
            console.log(this.iterationIndexes);
        }
    }
};
</script>
