        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col d-flex justify-content-center pt-4">
                    <div class="bars-cont">
                        ...
                        v-bind:style="{ height: item + 'px', background: trackIndex === i ? 'blue' : 'rgba(0, 68, 255, 0.664)' }">
            ...
            <div class="row">
                <div v-if="sortButton === 'block'" class="col d-flex justify-content-around align-items-center pt-4">
                    <div>
                        <input type="range" min="20" max="50" class="slider" id="myRange" v-model="speed">
                        <span class="ml-4">Speed: {{speed}} ms/iteration</span>
                    </div>

                    <div>
                        <input type="range" min="10" max="30" class="slider" id="myRange" v-model="setArrayLength">
